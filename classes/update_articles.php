<?php
class update_articles extends core_a {
	...
	public function get_content(){
		...
		if($_GET['id_text']){
			...
			exit("неправильні дані для сторінки");
		}
		$text = $this->get_text_articles($id_text);
...
<input type="text" name="title" class="input-article" value='$text[title]'>
<input type="hidden" name="id" class="input-article" value='$text[id]'>
